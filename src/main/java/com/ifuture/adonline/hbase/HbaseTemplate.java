...
/**
 * Central class for accessing the HBase API. Simplifies the use of HBase and helps to avoid common
 * errors. It executes core HBase workflow, leaving application code to invoke actions and extract
 * results.
 *
 * @author Costin Leau
                ...
                if (null == this.connection) {
                    try {
                        ...
                        this.connection = ConnectionFactory
                            .createConnection(configuration, poolExecutor);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
