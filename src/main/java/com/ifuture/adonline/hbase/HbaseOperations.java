...
public interface HbaseOperations {
    ...
    /**
     * Executes the given action against the specified table handling resource management. <p>
     ...
     * the scanning process. The content is processed row by row by the given action, returning a list
     * of domain objects.
     *
     * @param tableName target table
     ...
     * @return object mapping the target row
     */
    <T> T get(String tableName, final String rowName, final String familyName,
